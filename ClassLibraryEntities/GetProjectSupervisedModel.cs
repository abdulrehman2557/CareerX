...
namespace Entities
{
    public class GetProjectSupervisedModel
    {
      
        [StringLength(8, MinimumLength = 8, ErrorMessage = "ProjectSupervisedID must be 8 characters long.")]
        public string? ProjectSupervisedID { get; set; }
        ...
        [Required]
        public int TechnologyUsed { get; set; }
